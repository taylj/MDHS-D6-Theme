...
<div id="search" class="container-inline">
  <label>Search:</label>
  <input class="search-input form-text" type="text" maxlength="128" name="search_theme_form" id="edit-search-theme-form-header"  size="18" value="<?php print t('Search the University'); ?>" title="<?php print t('Enter search terms') ?>" />
  <input type="submit" name="op" value="<?php print t('Search') ?>"  />
